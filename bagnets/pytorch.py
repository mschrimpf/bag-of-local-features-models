...
def bagnet33(pretrained=False, strides=[2, 2, 2, 1], **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['bagnet33'], map_location=lambda storage, loc: storage))
    return model
...
def bagnet17(pretrained=False, strides=[2, 2, 2, 1], **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['bagnet17'], map_location=lambda storage, loc: storage))
    return model
...
def bagnet9(pretrained=False, strides=[2, 2, 2, 1], **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['bagnet9'], map_location=lambda storage, loc: storage))
    return model
